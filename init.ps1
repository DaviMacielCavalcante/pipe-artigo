...
docker exec -it spark-master bash -c "cd /opt/spark/work-dir && /opt/spark/bin/spark-submit --conf spark.jars.ivy=/tmp/ivy --packages com.datastax.spark:spark-cassandra-connector_2.12:3.4.1 --master spark://spark-master:7077 scripts/silver.py"